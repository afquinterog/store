...
if ( function_exists( 'YITH_YWRAQ_Frontend' ) ) {
	...
	if( ! function_exists( 'woodmart_show_button_single_page' ) ) {
		function woodmart_show_button_single_page(){
			global $product;
		...
		add_action( 'woocommerce_before_single_product', 'woodmart_show_button_single_page', 35 );
	}
}
