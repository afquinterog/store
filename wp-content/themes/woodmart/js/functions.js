    ...
    woodmartThemeModule = (function() {
        ...
        return {
            ...
            fullScreenMenu : function(){
                ...
                $( '.full-screen-nav .menu-item-design-default.menu-item-has-children, .full-screen-nav .menu-item-design-default.menu-item-has-children .menu-item-has-children, .full-screen-nav .menu-item-design-sized.menu-item-has-children, .full-screen-nav .menu-item-design-full-width.menu-item-has-children' ).append( '<span class="icon-sub-fs"></span>' );
